DROP TABLE
IF EXISTS pp_special_code_master;
CREATE TABLE pp_special_code_master LIKE pp_special_code;
INSERT IGNORE INTO pp_special_code_master (
	pp_special_code_master.CODE,
	pp_special_code_master.NAME
)
VALUES
-- pp_special_code versionn 2024-04-01
...
INSERT IGNORE INTO pp_special_code (
	...
	pp_special_code_master.`name`
FROM
	pp_special_code_master
WHERE
	pp_special_code_master.`code` NOT IN (
		SELECT
			pp_special_code.`code`
		FROM
			pp_special_code
